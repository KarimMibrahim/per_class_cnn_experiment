...
RESULTS_SAVING_Path = "C1_square_30secs_Results"
...
def main():
    ...
    for idx,label in enumerate(LABELS_LIST):
        ...
        training_dataset,training_classes = load_train_set_raw(os.path.join(SOURCE_PATH, "GroundTruth/Uncategorized_groundtruth/", 
        ...
        spectrograms, test_classes,songs_ID = load_test_set_raw(os.path.join(SOURCE_PATH, "GroundTruth/Uncategorized_groundtruth/", 
