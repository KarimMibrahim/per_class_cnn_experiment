...
dict = {
    'car': ['club','morning','sad','sleep','shower','relax']
    ...
    'happy': ['sad' , 'sleep', 'morning', 'club'],
    'morning': ['night', 'sleep','club', 'sad'], 
    'night': ['morning','dance', 'chill', 'party', 'sleep'],
    'party': ['chill','sleep','sad','relax','work','morning'],
    'relax': ['club','gym','dance','party','workout'],
    'running': ['club', 'relax','sad', 'sleep'],
    'sad': ['happy', 'club','gym','dance','party','workout'],
    'sleep': ['club','gym','dance','party','workout'],
    'summer':['club','morning','relax','sad','sleep'],
    'training':['club','morning','relax','sad','sleep'],
    'work': ['club','morning','sad','sleep'],
